              ...
              <div class="d-flex">
                ...
                <div class="ms-auto text-muted">
                  ...
                  <div class="ms-2 d-inline-block">
                    <input wire:model.live='searchData' type="text" class="form-control form-control-sm" aria-label="Cari Data Pelajaran">
                  </div>
                </div>
              </div>
            </div>
              ...
              <table class="table card-table table-vcenter text-nowrap datatable">
                <thead>
                  <tr>
                    ...
                    <th width="10%">Nama Pelajaran</th>
                    <th width="60%">Keterangan Pelajaran</th>
                    <th width="30%">Aksi</th>
                  </tr>
                </thead>
                <tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header"> 
          ...
          <h5 class="modal-title">Detail Data Pelajaran</h5>
          @else
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input {{ $detailMode?"disabled":""}} type="text" class="form-control" name="nama" placeholder="Nama Mata Pelajaran" wire:model='nama'>
            @error('nama')
