      ...
      <div class="navbar">
        <div class="container-xl">
          <ul class="navbar-nav">
            ...
            <li class="nav-item {{ $menu=="point"?"active":"" }} dropdown">
                <a class="nav-link dropdown-toggle" href="#navbar-point" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
